...
export function createAppWindow(): BrowserWindow {
  ...
  // This window only ever shows the web app. Anything else — including the
  // Google sign-in the web app used to navigate to in place — goes to the
  // default browser, which is both what Google requires of OAuth (an embedded
  // user agent is rejected with `disallowed_useragent`) and what the user
  // expects of an external link.
